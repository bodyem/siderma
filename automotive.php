	...
	<div class="container">
		<div class="left_menu">
			<ul class="dropdownn">
							...
							<a href="automotive.php?product=mochete_auto"><img src="components/papuc.png" width="25" height="25" style="float:left; margin-top:7px;"><span style="float:left;margin-left:30px;" valign="middle">Mochete auto</span></a>
								
					
							</li>
					
					
							<li class="itemz"><a href="automotive.php?product=tableta"><img src="components/papuc.png" width="25" height="25" style="float:left"><span style="float:left;margin-left:30px;">Tableta</span></a>
								
							</li>
					
					
							<li ><a href="automotive.php?product=tapiterii_cap_auto"><img src="components/papuc.png" width="25" height="25" style="float:left"><span style="float:left;margin-left:30px;">Tapiterii</span></a>
							</li>
